...
public final class MutableEnvironment extends MutableEntity<EnvironmentSimulationContext, EnvironmentContext, MutableEnvironmentAttributeSet, AttributeSetLog<EnvironmentSimulationContext>> implements Environment {
     ...
     */
    public MutableEnvironment(String name, List<MutableEnvironmentAttributeSet> attributeSets) {
     ...
     * @param attributeSets the attribute sets the environment will own
     */
    public MutableEnvironment(List<MutableEnvironmentAttributeSet> attributeSets) {
