 ...
 * {@link MutableAgent} and {@link MutableEnvironment}.
 *
 ...
 */
public sealed abstract class MutableEntity<SC extends SimulationContext, C extends Context, AS extends MutableAttributeSet<SC,C>, ASL extends AttributeSetLog<SC>> implements Entity
        permits MutableAgent, MutableEnvironment {
     ...
     */
    protected MutableEntity(String name, List<AS> attributeSetList) {
        this.name = name;
